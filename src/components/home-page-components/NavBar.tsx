...
import OutlinedButton from "../utilities/OutlinedButton";
    ...
    <div>
      <nav className="navbar navbar-expand-lg navbar-light bg-light bg-transparent">
        <div className="container-fluid">
          ...
          <a href="/">
            <h3 className="logo-text">Eventings</h3>
          </a>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form className="d-flex navbar navbar-nav">
              {authenticated ? (
                ...
                <div>
                  <a href="/events" className="btn-link mr-5">
                    Dashboard
                  </a>
                  <a href="/" onClick={logOut} className="btn-link ml-5">
                    Logout
                  </a>
                </div>
              ) : (
                <OutlinedButton href={"/login"} name="Login" />
              )}
            </form>
          </div>
        </div>
